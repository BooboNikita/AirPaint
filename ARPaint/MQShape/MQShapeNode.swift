...
class MQShapeNode: SCNNode {
    ...
    var preLocation = float3(0.0, 0.0, 0.0)
            ...
            if self._quantity > 0 {
                ...
                for i in 0..<self._quantity-1 {
                    ...
                    if (self._quantity - i + 1) <= self._lineVertices.count {
                        ...
                        print("lineindices \(UInt32(self._lineVertices.count - (self._quantity - i + 1))) \(UInt32(self._lineVertices.count - (self._quantity - i)))")
                    }
                }
